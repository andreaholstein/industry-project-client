    ...
    return (
        <section className="footer">
            <ul className="footer__segments">
                ...
                <a href="https://www.linkedin.com/showcase/scotia-wealth-management/?originalSubdomain=ca">
                    <li className="footer__segment-block">
                        <svg className="footer__segment-icon" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
